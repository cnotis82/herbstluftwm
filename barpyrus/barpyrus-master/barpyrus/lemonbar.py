...
class Lemonbar(EventInput):
    def __init__(self, geometry = None,
                 ...
                 symbol_font = 'Wuncon Siji:pixelsize=10:weight=Regular',
                 symbol_font_1 = 'Font Awesome 5 Free Solid:style=Solid',
                 symbol_font_2 = 'Font Awesome 5 Brands',
                 background = '#ff1d2021',
                 foreground = '#989898',
        ...
        if symbol_font != None:
            ...
            command += [ '-f', symbol_font_1 ]
            command += [ '-f', symbol_font_2 ]
